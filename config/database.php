    ...
    */
    ...
    'connections' => [
        ...
        'dbai' => [
            ...
            'database' => env('DB_DATABASE_DBAI', 'laravel'),
            'username' => env('DB_USERNAME_DBAI', 'root'),
        ...
        // Connessione di sola lettura usata da MedicalQueryController::execute()
        // per le query SQL generate dall'AI. Puntala a un utente MySQL con solo
        // privilegi SELECT (GRANT SELECT ON db.* TO 'readonly_ai'@'%'). Se le
        // variabili dedicate non sono impostate ricade sulle credenziali di 'mysql'.
        'mysql_readonly' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
