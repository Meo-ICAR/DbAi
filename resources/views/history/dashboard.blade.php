...
<div class="container mx-auto px-4 py-6">
    <!-- Debug Section -->
    @if(isset($debug_queries['histories_query']))
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-yellow-700">
                    <strong>SQL Query for Dashboard Items:</strong>
                    <div class="mt-1 p-2 bg-white rounded text-xs font-mono overflow-x-auto">
                        {{ $debug_queries['histories_query'] }}
                    </div>
                </p>
            </div>
        </div>
